...
class Purchasing_status_model extends MY_Model
{
	/* Module */
 	protected $folder_name			= "master/purchasing_status";
 	protected $table_name 			= _PREFIX_TABLE."option_purchasing_status";
