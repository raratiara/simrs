...
class Kategori_supplier_model extends MY_Model
{
	/* Module */
 	protected $folder_name			= "master/kategori_supplier";
 	protected $table_name 			= _PREFIX_TABLE."option_supplier_category";
