...
{
	/* Module */
 	protected $folder_name			= "master/city";
 	protected $table_currname 		= _PREFIX_TABLE."option_province";
 	protected $table_name 			= _PREFIX_TABLE."option_city";
	...
	public function get_list_data()
	{
		...
		$sTable = ' '.$this->table_name.' a 
					LEFT JOIN '.$this->table_currname.' b ON a.id_province = b.id
					';
	...
	public function add_data($post) {
		...
		$data = [
			...
			'id_province' 		=> trim($post['id_province']),
			'active' 			=> $active,
	...
	public function getRowData($id) { 
		...
		if(!empty($rs->id_province)){
			$rd = $this->db->select('description as province')->where([$this->primary_key => $rs->id_province])->get($this->table_currname)->row();
