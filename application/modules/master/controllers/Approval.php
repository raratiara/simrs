...
{
	/* Costs */
 	const  LABELMODULE				= "master_approval"; // identify menu
 	const  LABELMASTER				= "Approval";
 	const  LABELFOLDER				= "master"; // module folder
 	const  LABELPATH				= "approval"; // controller file (lowercase)
	...
	public $tabel_header 			= ["ID","Deskripsi","Active"];
	
	/* Export */
	public $colnames 				= ["ID","Deskripsi","Active"];
	public $colfields 				= ["id","description","is_active"];
