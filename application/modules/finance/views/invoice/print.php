...
if($rs->date_invoice > _CUT_OFF_LOGO){
	$new_logo = TRUE;
...
<head>
    <meta charset="utf-8">
    <title>Invoice # <?=$rs->invoice;?></title>
...
<body>
    <div class="invoice-box">
        <table cellpadding="0" cellspacing="0">
                ...
                <td colspan="6">
                    ...
                    <table>
                        <tr>
                            ...
                            <td class="title">
                                <span class="comp-box">Invoice</span>
                            </td>
                        </tr>
                    </table>
					</div>
                    ...
                    <table>
                        <tr>
                            ...
                            <td>
                                ...
                                <span class="label-box">Invoice No</span><span class="inter">:</span><span class="info-box"><?=$rs->invoice;?></span><br/>
			...
			if($rs->ppn > 0){
                if (date('Y-m-d',$rs->date_invoice) > '2024-12-31') {
            ?>
                <tr class="total">
                    <td colspan="4"></td>
                    <td>
                    ...
                    <td>
                        <?=number_format($rs->dpp,0,',','.');?>
                    </td>
                </tr>
                <tr class="total">
                    <td colspan="4"></td>
                    <td>
                        PPN(<?=($rs->ppn/$rs->subtotal)*100;?>%)
                    </td>
                    <td>
            ...
            <tr>
                ...
                <td colspan="2" class="bsign">
					...
					<span class="bottom-qrcode"><?=isset($rs->qrpath)?'<img width="100px" src="'.$rs->qrpath.'" /><br><div class="txt-qrcode">'.$rs->invoice.'</div>':'';?></span></td>
            </tr>
        </table>
    </div>
</body>
