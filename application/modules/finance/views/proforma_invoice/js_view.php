			...
			if(data != false){
				if(save_method == 'update'){
					...
					$.ajax({type: 'post',url: module_path+'/getppntarrif',data: { udate:data.dinvoice },success: function (response) {
							...
							$.ajax({type: 'post',url: module_path+'/genpinvoiceitemrow',data: { id:data.id },success: function (response) {
				...
				if(save_method == 'detail'){
					...
					$.ajax({type: 'post',url: module_path+'/genpinvoiceitemrow',data: { id:data.id,view:true },success: function (response) {
							var obj = JSON.parse(response);
...
$("#addrow").on("click", function () {
	expire();
	var newRow = $("<tr>");
	$.ajax({type: 'post',url: module_path+'/genpinvoiceitemrow',data: { count:wcount },success: function (response) {
