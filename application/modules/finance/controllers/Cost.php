...
{
	/* Costs */
 	const  LABELMODULE				= "finance_cost"; // identify menu
 	const  LABELMASTER				= "Project Cost";
 	const  LABELFOLDER				= "finance"; // module folder
 	const  LABELPATH				= "cost"; // controller file (lowercase)
	...
	public $tabel_header 			= ["ID","No Project","Nama Project","Total Anggaran","Sisa Anggaran"];
