...
class Proforma_invoice extends MYP_Controller
{
	...
	public function form_field_asset()
	{
		...
		$field['worth'] 			= $this->self_model->return_build_txt('0','grandtotal','grandtotal','','text-align: right;','readonly').$this->self_model->return_build_txthidden('0','dpp','dpp').$this->self_model->return_build_txthidden('0','ppn','ppn').$this->self_model->return_build_txthidden('0','pph','pph').$this->self_model->return_build_txthidden('0','other_tax','other_tax').$this->self_model->return_build_txthidden('0','worth','worth').$this->self_model->return_build_txthidden($vCoretax,'coretax','coretax');
