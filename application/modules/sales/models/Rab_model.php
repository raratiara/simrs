...
class Rab_model extends MY_Model
{
	/* Module */
 	protected $folder_name			= "sales/rab";
	...
	public function get_list_data()
	{
		...
		foreach($rResult as $row)
		{
			...
			array_push($output["aaData"],array(
				...
				$row->project,
				$row->title,
				number_format($row->nilai_proyek,0,",","."),
				number_format($row->nilai_anggaran,0,",","."),
				number_format($row->nilai_margin,0,",",".")
			));
		}
