...
{
	/* Costs */
 	const  LABELMODULE				= "sales_rab"; // identify menu
 	const  LABELMASTER				= "RAB Project";
 	const  LABELFOLDER				= "sales"; // module folder
 	const  LABELPATH				= "rab"; // controller file (lowercase)
	...
	public $tabel_header 			= ["ID","No Project","Nama Project","Nilai Project","Total Anggaran","Margin"];
