...
if($rs->date_receive > _CUT_OFF_LOGO){
	$new_logo = TRUE;
        ...
        <table cellpadding="0" cellspacing="0">
                ...
                <td colspan="6">
                    <table>
                        <tr>
                            ...
                            <td>
                                <span class="label-box">Date Receive</span><span class="inter">:</span><span class="info-box"><?=date('F j, Y',$rs->date_receive);?></span><br/>
            ...
            <tr class="information">
                <td colspan="6">
                    <table>
                        <tr>
                            <td>
								<span class="label-to">Shipper : <?=isset($rs->shipper_name)?$rs->shipper_name:'';?></span><br/>
                                <span class="label-to">Shipper Telp: <?=isset($rs->shipper_telp)?$rs->shipper_telp:'';?></span><br/>
                                <span class="label-to-address">Shipper Address: <br><?=isset($rs->shipper_address)?nl2br($rs->shipper_address):'';?></span>
                            </td>
                            <td>
                                <!-- empty -->
                            </td>
            ...
            <tr>
                ...
                <table style="border: 1px solid black; border-collapse: collapse; width: 100%;">
                    ...
                    <tr>
                        <td style="border: 1px solid black; height: 100px; text-align: center; vertical-align: bottom;"></td>
                        <td style="border: 1px solid black; height: 100px; text-align: center; vertical-align: bottom;"></td>
                        <td style="border: 1px solid black; height: 100px; text-align: center; vertical-align: bottom;"></td>
                        <td style="border: 1px solid black; height: 100px; text-align: center; vertical-align: bottom;"></td>
                    </tr>
