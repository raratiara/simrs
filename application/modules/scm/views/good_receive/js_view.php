        ...
        success: function(data)
        {
			if(data != false){
				if(save_method == 'update'){
					...
					$('[name="shp_name"]').val(data.shipper_name);
					$('[name="shp_address"]').val(data.shipper_address);
					$('[name="shp_telp"]').val(data.shipper_telp);
				...
				if(save_method == 'detail'){
					...
					$('span.sp_name').html(data.shipper_name);
					$('span.sp_address').html(data.shipper_address);
					$('span.sp_telp').html(data.shipper_telp);
