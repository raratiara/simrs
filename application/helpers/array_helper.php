...
if (!function_exists('values_satisfied')) {
    /**
     * Values Satisfied.
     *
     * Returns TRUE/FALSE while check all array items value againts check value. Will return TRUE if
     * match value exist in array.
     *
     * @param	array
     * @param	string
     * @param	mixed
     ...
     * @return mixed depends on what the array contains
     */
    function values_satisfied($array, $check = NULL)
    {
		$return = FALSE;
