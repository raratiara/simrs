...
class Project_performance_model extends MY_Model
{
	/* Module */
 	protected $folder_name			= "sales/project_performance";
 	protected $table_name 			= _PREFIX_TABLE."data_rab_project";
	...
	public function get_list_data()
	{
		...
		foreach($rResult as $row)
		{
			...
			array_push($output["aaData"],array(
				...
				$row->project,
				$row->title,
				number_format($row->nilai_po,0,",","."),
				number_format($row->nilai_total_cost,0,",","."),
				number_format($row->nilai_performance_margin,0,",",".")
			));
		}
