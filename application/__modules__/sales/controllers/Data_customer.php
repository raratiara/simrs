...
{
	/* Costs */
 	const  LABELMODULE				= "sales_data_customer"; // identify menu
	...
	public $tabel_header 			= ["ID","ID Mitra","Nama","Contact","Telp","Email","Status"];
	
	/* Export */
	public $colnames 				= ["ID","ID Mitra","Nama","Alamat","Contact","Telp","Email","NIB","NPWP","Bank","Rekening","Status"];
