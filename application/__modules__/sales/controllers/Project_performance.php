...
class Project_performance extends MY_Controller
{
	/* Costs */
 	const  LABELMODULE				= "sales_project_performance"; // identify menu
 	const  LABELMASTER				= "Project Performance";
 	const  LABELFOLDER				= "sales"; // module folder
 	const  LABELPATH				= "project_performance"; // controller file (lowercase)
	...
	public $tabel_header 			= ["ID","No Project","Nama Project","Nilai PO","Total Cost","Margin"];
