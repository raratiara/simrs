											...
											<form method="post" name="frmData" id="frmData"  class="form-horizontal" role="form">
												...
												<div class="form-group">
													...
													<div class=" col-md-7">
											 		...
											 		<div class="form-group">
														<label class="col-sm-3 control-label no-padding-right" for="form-field-1"></label> 
				 										...
				 										<div class="col-sm-1"> Import </div>
				 										<div class="col-sm-1"> Eksport </div>
													</div> 
													<?php
													...
													<div class="form-group">
														<label class="col-sm-3 control-label no-padding-right"><?php echo $title;?></label> 
				 										<div class="col-sm-1"><input <?php echo  $check_view;?> type="checkbox" class="checkbox_view" name="view_<?php echo $r["user_menu_id"];?>" id="view_<?php echo $r["user_menu_id"];?>" value="1" <?php echo $readonly;?>></div>
				 										...
				 										<div class="col-sm-1"><input <?php echo  $check_eksport;?>  type="checkbox" class="checkbox_eksport"  name="eksport_<?php echo $r["user_menu_id"];?>" id="eksport_<?php echo $r["user_menu_id"];?>" value="1" <?php echo $readonly;?>></div>
															...
															if (count($rs_1) > 0) {
																FOREACH ($rs_1 AS $r_1) {
																	...
																	<div class="form-group">
																		<label class="col-sm-3 control-label no-padding-right"><?php echo $title;?></label> 
								 										<div class="col-sm-1"><input <?php echo  $check_view;?> type="checkbox" class="checkbox_view" name="view_<?php echo $r_1["user_menu_id"];?>" id="view_<?php echo $r_1["user_menu_id"];?>" value="1" <?php echo $readonly;?>></div>
																...
																<?php
																	if (count($rs_2) > 0) {
																		FOREACH ($rs_2 AS $r_2) {
																			...
																			<div class="form-group">
																				<label class="col-sm-3 control-label no-padding-right"><?php echo $title;?></label> 
																				<div class="col-sm-1"><input <?php echo  $check_view;?> type="checkbox" class="checkbox_view" name="view_<?php echo $r_2["user_menu_id"];?>" id="view_<?php echo $r_2["user_menu_id"];?>" value="1" <?php echo $readonly;?>></div>
																			...
																			if (count($rs_3) > 0) {
																				FOREACH ($rs_3 AS $r_3) {
																					...
																					<div class="form-group">
																						...
																						<div class="col-sm-1"><input <?php echo  $check_view;?> type="checkbox" class="checkbox_view" name="view_<?php echo $r_3["user_menu_id"];?>" id="view_<?php echo $r_3["user_menu_id"];?>" value="1" <?php echo $readonly;?>></div>
																						<div class="col-sm-1"><input <?php echo  $check_add;?>  type="checkbox" class="checkbox_add" name="add_<?php echo $r_3["user_menu_id"];?>" id="add_<?php echo $r_3["user_menu_id"];?>" value="1" <?php echo $readonly;?>></div>
																						<div class="col-sm-1"><input <?php echo  $check_update;?> type="checkbox" class="checkbox_update" name="update_<?php echo $r_3["user_menu_id"];?>" id="update_<?php echo $r_3["user_menu_id"];?>" value="1" <?php echo $readonly;?>></div>
																						<div class="col-sm-1"><input <?php echo  $check_del;?> type="checkbox" class="checkbox_delete" name="delete_<?php echo $r_3["user_menu_id"];?>" id="delete_<?php echo $r_3["user_menu_id"];?>" value="1" <?php echo $readonly;?>></div>
																						<div class="col-sm-1"><input <?php echo  $check_detail;?>  type="checkbox" class="checkbox_detail"  name="detail_<?php echo $r_3["user_menu_id"];?>" id="detail_<?php echo $r_3["user_menu_id"];?>" value="1" <?php echo $readonly;?>></div>
																						<div class="col-sm-1"><input <?php echo  $check_import;?> type="checkbox" class="checkbox_import" name="import_<?php echo $r_3["user_menu_id"];?>" id="import_<?php echo $r_3["user_menu_id"];?>" value="1" <?php echo $readonly;?>></div>
																						<div class="col-sm-1"><input <?php echo  $check_eksport;?> type="checkbox" class="checkbox_eksport" name="eksport_<?php echo $r_3["user_menu_id"];?>" id="eksport_<?php echo $r_3["user_menu_id"];?>" value="1" <?php echo $readonly;?>></div>
																					</div> 
																				<?php
																				}
																			}
												...
												<div class="clearfix form-actions">
													<div class="col-md-offset-5 col-md-7">
														<button class="btn btn-info" type="reset" onclick="window.location.href='<?php echo base_url($sfolder.'/');?>'">
															<i class="fa fa-arrow-circle-o-left fa-lg bigger-110"></i>
															Kembali
														</button>
													</div>
												</div>
