...
class Activity_location_model extends MY_Model
{
	/* Module */
 	protected $folder_name			= "operation/activity_location";
 	protected $table_name 			= _PREFIX_TABLE."data_activity_location";
