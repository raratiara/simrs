        ...
        success: function(data)
        {
			if(data != false){
				if(save_method == 'update'){
					...
					$('[name="id_province"]').val(data.id_province).trigger('change.select2');
					$('[name="id_city"]').val(data.id_city).trigger('change.select2');
				...
				if(save_method == 'detail'){
					...
					$('span.province').html(data.province);
					$('span.city').html(data.city);
					$('span.kodepos').html(data.kodepos);
					var active = 'No';
					if(data.active == 1){
						active = 'Yes';
					}
