...
var modloc = '/admin/data_karyawan/';
        ...
        success: function(data)
        {
			if(data != false){
				if(save_method == 'update'){
					...
					$('[name="id_jabatan"]').val(data.id_jabatan).trigger('change.select2');
					$('[name="id_departemen"]').val(data.id_departemen).trigger('change.select2');
