...
class Data_ca_request extends MY_Controller
{
	/* Costs */
 	const  LABELMODULE				= "finance_data_ca_request"; // identify menu
 	const  LABELMASTER				= "Cash Advance - Request";
 	const  LABELFOLDER				= "finance"; // module folder
 	const  LABELPATH				= "data_ca_request"; // controller file (lowercase)
	...
	public $tabel_header 			= ["ID","CA","Project","WBS","Tgl Request","Total Request","Remaining Balance","Requestor","Departemen","Last Status"];
	
	/* Export */
	public $colnames 				= ["ID","CA","Project","WBS","Tgl Request","Total Request","Remaining Balance","Requestor","Departemen","Last Status"];
	public $colfields 				= ["id","ca","project_title","wbs","drequest","wrequest","remaining","requestor","departemen","status"];
