...
class Data_reimburse_model extends MY_Model
{
	/* Module */
 	protected $folder_name			= "finance/data_reimburse";
 	protected $table_name 			= _PREFIX_TABLE."data_reimburse_request";
	...
	/* upload */
 	protected $attachment_folder	= "./uploads/data/reimburse";
	...
	public function add_data($post) {
		...
		$data = [
			...
			'trequest' 			=> str_replace(",",".",str_replace(".","",trim($post['total_reim']))),
	...
	private function setLink($i,$f,$holder=''){
		$link = '';
		if($f){
			$link = '<a href="/uploads/data/reimburse/'.$i.'/'.$f.'" class="'.$holder.'" target="_blank">'.$f.'</a>';
		}
