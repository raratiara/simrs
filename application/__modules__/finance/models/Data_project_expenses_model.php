...
class Data_project_expenses_model extends MY_Model
{
	/* Module */
 	protected $folder_name			= "finance/data_project_expenses";
 	protected $table_name 			= _PREFIX_TABLE."data_project_expenses";
